...
namespace AddressBook.CurrentPupil.Test.Permissions
{
    class AdmissionsOfficer
    {
        ...
        #region AdmissionsOfficerQuickControlAccess()
        ...
        #region AdmissionsOfficerSearchCurrentPupilsAccess
        [WebDriverTest(Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]

        public void AdmissionsOfficerSearchCurrentPupilsAccess()
        {
            Assert.That(QuickControlAccess.hasPermissionToSearchCurrentPupil(SeleniumHelper.iSIMSUserType.AdmissionsOfficer, textForSearch) >= 0);
        }
        #endregion

        #region AdmissionsOfficerPupilBasicDetailsAccess
        [WebDriverTest(Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]

        public void AdmissionsOfficerPupilBasicDetailsAccess()
        {
            Assert.IsTrue(QuickControlAccess.canViewBasicDetailsCurrentPupil(SeleniumHelper.iSIMSUserType.AdmissionsOfficer, textForSearch));
        }
        #endregion

        #region AdmissionsOfficerPupilTelephoneDetailsAccess
        [WebDriverTest(Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]

        public void AdmissionsOfficerPupilTelephoneDetailsAccess()
        {
            Assert.IsTrue(QuickControlAccess.canViewPupilTelephoneDetails(SeleniumHelper.iSIMSUserType.AdmissionsOfficer, textForSearch));
        }
        #endregion

        #region AdmissionsOfficerPupilEmailDetailsAccess
        [WebDriverTest(Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]
        ...
        #region Data Provider for DisplayPupilAddressDetails for Admission officer
        public List<object[]> PupilsWithAddressDataForAdmissionOff()
        {
            string pattern = "M/d/yyyy";
            string pupilSurname = "AdmissionOfficerPupilsWithAddressData" + POM.Helper.SeleniumHelper.GenerateRandomString(3);
            string pupilForename = "AdmOfficerPupilsWithAddressData" + POM.Helper.SeleniumHelper.GenerateRandomString(3);
            ...
            var res = new List<object[]>
            {
                ...
                DateOfAdmission, "Year 2",new string[]{"22567", "House Name1", "Flat31", "Street31", "District31", "City31", "County21", "EC1A 1BB", "United Kingdom"},}
            };
            return res;
        }
        #endregion
        ...
        #region AdmissionsOfficerPupilAddressDetailsAccess
        [WebDriverTest(DataProvider = "PupilsWithAddressDataForAdmissionOff", Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]

        public void AdmissionsOfficerPupilAddressDetailsAccess(string forenameSetup, string surnameSetup, string gender, string dateOfBirth, string DateOfAdmission, string yearGroup, string[] currentAddress)
        {
        ...
        #region AdmissionsOfficerLinkToPupilRecordFromPupilInfoAccess
        [WebDriverTest(Enabled = true, Groups = new[] { AddressBookTestGroups.CurrentPupilQuickSearch, AddressBookTestGroups.CurrPupilPermissions }, Browsers = new[] { BrowserDefaults.Chrome })]
        [Variant(Variant.NorthernIrelandStatePrimary)]
