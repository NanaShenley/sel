...
namespace Admissions.Component
{
    ...
    {
        public static string ApplicationStatusDefaultColumnNumber = "6"; // ApplicationStatus will be column 5 (providing no columns have been added or removed)
        ...
        private void ExecuteJavaScriptToBulkSelectApplicationStatus()
        {
            ...
            string script = "$('div[class=\"webix_ss_header\"] td[column=\"6\"] span:contains(\"Application Status\")').click();" +
                            "$('div[class=\"webix_ss_header\"] td[column=\"6\"] span:contains(\"Application Status\")').closest('div').find('i.high-volume-grid-spreadsheet-menu')[0].click();";
