...
namespace Admissions.Component
{
    public class ApplicationStatusSearch : BaseSeleniumComponents
    {
        ...
        {
            var yearGroupDdl = PageObjectModel.Helper.SeleniumHelper.Get(YearGroupValue);
            return yearGroupDdl.Text;
        }

        public string GetIntakeGroupValue()
        {
            var yearGroupDdl = PageObjectModel.Helper.SeleniumHelper.Get(IntakeGroupValue);
            return yearGroupDdl.Text;
        }

        public string GetAdmissionGroupValue()
        {
            var yearGroupDdl = PageObjectModel.Helper.SeleniumHelper.Get(AdmissionGroupValue);
            return yearGroupDdl.Text;
        }
