...
namespace Admissions.Component
{
    public class ParentalSalutationAndAddresseeDetail : BaseSeleniumComponents
    {
        ...
        public static By FloodFillSalutationDeleteLink = By.CssSelector("[data-menu-column-id='_ParentalSalutation'] [data-automation-id='link_bulkupdate_applicant_parental_salutation_and_addressee_floodfill_delete']");
        public static By FloodFillAddresseeDeleteLink = By.CssSelector("[data-menu-column-id='_ParentalAddressee'] [data-automation-id='link_bulkupdate_applicant_parental_salutation_and_addressee_floodfill_delete']");
        ...
        public static void DeleteParentalSalutationColumnValues()
        {
            CommonDelete(ExecuteJavaScriptToBulkSelectParentalSalutation, FloodFillSalutationDeleteLink);
        }
        ...
        public static void DeleteParentalAddresseeColumnValues()
        {
            ExecuteJavaScriptToBulkSelectParentalAddressee();
            SeleniumHelper.WaitForElementClickableThenClick(FloodFillAddresseeDeleteLink);
            SeleniumHelper.Get(DeleteFloodFillConfirmationDailog);
            SeleniumHelper.WaitForElementClickableThenClick(FloodFillConfirmDelete);
            WaitUntillAjaxRequestCompleted();
        }
        ...
        public static void ExecuteJavaScriptToBulkSelectParentalAddressee()
        {
            ...
            WaitUntilDisplayed(ParentalAddressee);
        ...
        public static void ExecuteJavaScriptToBulkSelectParentalSalutation()
        {
            ...
            WaitUntilDisplayed(ParentalSalutation);
            parentalSalutationHeader.ScrollToByAction();
            var js = (IJavaScriptExecutor)WebContext.WebDriver;
            WaitUntillAjaxRequestCompleted();
