...
namespace Admissions.Data
{
    public static class PurgeLinkedData
    {
        ...
        public static void DeleteTier4Category(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4Category WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteTier4Evidence(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4Evidence WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteTier4Region(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4Region WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteTier4VisaType(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4VisaType WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteTier4VisaStatus(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4VisaStatus WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteTier4Reason(string code)
        {
            var sql = string.Format("DELETE FROM dbo.Tier4Reason WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }
        ...
        public static void DeleteAdmissionTerm(string code)
        {
            var sql = string.Format("DELETE FROM dbo.AdmissionTerm WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }
        ...
        public static void DeleteMarketingResource(string code)
        {
            var sql = string.Format("DELETE FROM dbo.MarketingSource WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }

        public static void DeleteEnquiryReason(string code)
        {
            var sql = string.Format("DELETE FROM dbo.ReasonForEnquiry WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }


        public static void DeleteEnquiryWithdrawnreason(string code)
        {
            var sql = string.Format("DELETE FROM dbo.ReasonEnquiryWithdrawn WHERE Code='{0}'", code);
            DataAccessHelpers.Execute(sql);
        }
