...
using Retry = PageObjectModel.Helper.Retry;
using SimsBy = PageObjectModel.Helper.SimsBy;

namespace PageObjectModel.Components.Admission
{
    public class LookupWithCategoryPage : BaseComponent
    {
        ...
        public class LookupWithCategory : GridRow
        {
        ...
        public GridComponent<LookupWithCategory> TableRow
        {
            get
            {
                GridComponent<LookupWithCategory> returnValue = null;
                Retry.Do(() =>
                {
                    returnValue = new GridComponent<LookupWithCategory>(By.CssSelector("[data-maintenance-grid-id='LookupsWithCategoryGrid1']"), ComponentIdentifier);
                });
                return returnValue;
            }
        }
