...
namespace Admissions.SchoolIntake.Tests
{
    public class SchoolIntakeTests
    {
        ...
        public void Create_New_Active_School_Intake()
        {
            ...
            AutomationSugar.NavigateMenu("Tasks", "Admissions", "Intake and Admission Groups");
            ...
            schoolIntakeTriplet.SearchCriteria.SearchYearAdmissionYear = admissionYear;
            schoolIntakeTile = searchResults.FirstOrDefault();
            ...
            Assert.AreEqual(null, (admissionGroupTable.Rows.SingleOrDefault(x => x.Name == admissionGroupName && x.DateOfAdmission == dateOfAdmission &&
        ...
        /// </summary>
        [WebDriverTest(TimeoutSeconds = 1200, Enabled = false, Browsers = new[] { BrowserDefaults.Chrome },
            Groups = new[] { "P2", "SchoolIntake" })]
        public void Delete_Active_School_Intake()
        {
            ...
            using (new DataSetup(purgeBeforeInsert: false, purgeAfterTest: true, packages: dataPackage))
            {
                ...
                var searchResults = schoolIntakeTriplet.SearchCriteria.Search();
                var schoolIntakeTile = searchResults.FirstOrDefault();
