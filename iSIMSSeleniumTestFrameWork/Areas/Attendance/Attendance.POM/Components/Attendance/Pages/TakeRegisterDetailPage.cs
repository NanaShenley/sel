...
namespace POM.Components.Attendance
{
    public class TakeRegisterDetailPage : BaseComponent
    {
        ...
        {
            var _successMessage = SeleniumHelper.Get(SimsBy.AutomationId("status_success"));
        ...
        public IList<IWebElement> GetCodeList()
        {
            ...
            IList<IWebElement> Codes = WebContext.WebDriver.FindElements(By.CssSelector("[data-automation-id='Dropdown_Menu'] .menu-item-tile"));
