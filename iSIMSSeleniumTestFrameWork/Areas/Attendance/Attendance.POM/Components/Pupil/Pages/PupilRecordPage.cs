...
namespace POM.Components.Pupil
{
    public class PupilRecordPage : BaseComponent
    {
        ...
        [FindsBy(How = How.Id, Using = "IsMailingPoint")]
        ...
        public class LearnerPreviousSchoolsRow
        {
            ...
            [FindsBy(How = How.CssSelector, Using = "[data-automation-id*='edit']")]
        ...
        {
            [FindsBy(How = How.CssSelector, Using = "[id^='LearnerConsentTypes']")]
        ...
        [FindsBy(How = How.Id, Using = "IsDisabled")]
        ...
        [FindsBy(How = How.Id, Using = "IsTaughtThroughIrishMedium")]
        ...
        [FindsBy(How = How.CssSelector, Using = "[id='JobSeekerAllowance']")]
        ...
        [FindsBy(How = How.CssSelector, Using = "[id='ELBProvidesTransport']")]
        ...
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='add_school_button']")]
        ...
        public SelectSchoolTripletDialog OpenAddSchoolDialog()
        {
        ...
        public void SelectPersonalDetailsTab()
        {
            ...
            {
                POM.Helper.Retry.Do(_personalDetailsTab.Click);
            }
            else
            {
                _moreTab.ClickByJS();
                POM.Helper.Retry.Do(_personalDetailsHiddenTab.Click);
            }
            Wait.WaitForElementDisplayed(POM.Helper.SimsBy.Name("LegalForename"));
        }
        ...
        public void SelectPhoneEmailTab()
        {
            if (SeleniumHelper.Get(By.CssSelector("[data-automation-id='section_menu_Phone/Email']")).Displayed)
            {
                ...
                SeleniumHelper.Get(By.CssSelector("[data-automation-id='section_menu_Phone/Email']")).Click();         
            }
            else
            {
                _moreTab.ClickByJS();
                POM.Helper.Retry.Do(_phoneEmailHiddenTab.Click);
            }
            Wait.WaitForElementDisplayed(POM.Helper.SimsBy.CssSelector("[data-maintenance-container='LearnerTelephones']"));
        }
        ...
        public void SelectMedicalTab()
        {
            ...
            {
                Retry.Do(_medicalTab.ClickByJS);
                //_medicalTab.ClickByJS();
        ...
        public void SelectMedicalTabTwice()
        {
            if (SeleniumHelper.Get(By.CssSelector("[data-automation-id='section_menu_Medical']")).Displayed)
            {
        ...
        public void SelectAdditionalTab()
        {
            ...
            {
                POM.Helper.Retry.Do(_additionalTab.Click);
            }
            else
            {
                _moreTab.ClickByJS();
