...
namespace POM.Components.SchoolManagement
{
    public class AcademicYearDetailPage : BaseComponent
    {
        ...
        public class WorkingWeek
        {
            ...
            [FindsBy(How = How.CssSelector, Using = "[id$='Day3']")]
            private IWebElement _wedCheckBox;

            [FindsBy(How = How.CssSelector, Using = "[id$='Day4']")]
            private IWebElement _thuCheckBox;

            [FindsBy(How = How.CssSelector, Using = "[id$='Day5']")]
            private IWebElement _friCheckBox;

            [FindsBy(How = How.CssSelector, Using = "[id$='Day6']")]
            private IWebElement _satCheckBox;

            [FindsBy(How = How.CssSelector, Using = "[id$='Day7']")]
            ...
            public bool Monday
            {
                set { _monCheckBox.Set(value); }
                get { return _monCheckBox.IsChecked(); }
            }

            public bool Tuesday
            {
                set { _tueCheckBox.Set(value); }
                get { return _tueCheckBox.IsChecked(); }
            }

            public bool Wednesday
            {
                set { _wedCheckBox.Set(value); }
                get { return _wedCheckBox.IsChecked(); }
            }

            public bool Thurday
            {
                set { _thuCheckBox.Set(value); }
                get { return _thuCheckBox.IsChecked(); }
            }

            public bool Friday
            {
                set { _friCheckBox.Set(value); }
                get { return _friCheckBox.IsChecked(); }
            }

            public bool Saturday
            {
                set { _satCheckBox.Set(value); }
                get { return _satCheckBox.IsChecked(); }
            }

            public bool Sunday
            {
                set { _sunCheckBox.Set(value); }
                get { return _sunCheckBox.IsChecked(); }
            }
