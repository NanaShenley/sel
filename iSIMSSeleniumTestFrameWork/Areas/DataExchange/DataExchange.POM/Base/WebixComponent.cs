...
namespace DataExchange.POM.Base
{
    public class WebixComponent<Cell> : BaseComponent where Cell : WebixCell, new()
    {
        ...
        public IList<WebixRow<Cell>> Rows
        {
            get
            {
    ...
    public class WebixRow<Cell> where Cell : WebixCell, new()
    {
        ...
        public void ClickCellPupilName()
        {
            try
            {
                ...
                if (_button.IsExist())
                {
                    _button.ClickAndWaitFor(SimsBy.CssSelector(".popover"));
                }
            }
            catch (Exception) { }
        }
    ...
    public class WebixCell
    {
        ...
        public virtual string Text
        {
            ...
            set
            {
                ...
                {
                    SeleniumHelper.FindElement(By.Name("AttendanceRecord.SchoolAttendanceCode")).SendKeys(Keys.Delete);
                }
        ...
        public void ClickToOpenDropDown()
        {
            try
            {
                IWebElement elementTarget = webElement.ClickUntilAppearElement(By.Name("AttendanceRecord.SchoolAttendanceCode"));
                elementTarget.ClickUntilAppearElement(By.CssSelector("[view_id='$suggest1_list']"));
            }
            catch (Exception ex)
            {
                return;
