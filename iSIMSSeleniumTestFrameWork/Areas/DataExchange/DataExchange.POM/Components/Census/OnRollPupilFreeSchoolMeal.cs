...
{
    public class OnRollPupilFreeSchoolMeal
    {
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='section_menu_On Roll Pupil']")]
        private IWebElement _onrollPupilSection;

        [FindsBy(How = How.Name, Using = "OnRollPupilSection.OnRollPupilFSMs")]
        private IWebElement _onrollPupilFSMGrid;

        public OnRollPupilFreeSchoolMeal()
        {
        ...
        {
            get { return new WebixComponent<OnRollCell>(_onrollPupilFSMGrid); }
        }
