...
{
    public class OnRollPupilHomeInfoSection
    {
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='section_menu_On Roll Pupil']")]
        private IWebElement _onrollPupilSection;

        [FindsBy(How = How.Name, Using = "OnRollPupilSection.OnRollPupilAddresses")]
        private IWebElement _onrollPupilHomeInfoGrid;

        public OnRollPupilHomeInfoSection()
        {
            PageFactory.InitElements(WebContext.WebDriver, this);
        }

        public WebixComponent<OnRollCell> OnRollPupilHomeInfoGrid
        {
            get { return new WebixComponent<OnRollCell>(_onrollPupilHomeInfoGrid); }
        }
        ...
        {
            return OnRollPupilHomeInfoGrid.RowCount > 0;
        }
