...
#pragma warning restore 0649
        ...
        public SignInPage()
        {         
            Wait.WaitForElement(SimsBy.AutomationId("email-account-login"));          
        ...
        public void SignIn()
        {
            WebContext.WebDriver.FindElement(By.CssSelector("[data-automation-id='sign-in-account-login']")).SendKeys(Keys.Enter);
        }
