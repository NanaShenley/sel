...
namespace DataExchange.Tests.Census
{
    public class Summer2017
    {
        ...
        /// </summary>
        /// 
        private const string period = "_Summer2017";
        ...
        private const string Sign_Off_Button = "authorise_button";
        private const string Sign_off_return_button = "authorise_return_button";
        ...
        ///<summary>
        /// Test to check if widget exists with proper text on it
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void WidgetCheckForSummer2017()
        {
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.ReturnsManager);
            Wait.WaitTillAllAjaxCallsComplete();
        ...
        ///<summary>
        /// Test to check if Data Error grid exists
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void DataErrorCheckForSummer2017()
        {
        ...
        ///<summary>
        /// Test to check if All Pupils grid exists
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void ShowAllPupilCheckForSummer2017()
        {
            NavigateToReturnPage();
            Wait.WaitTillAllAjaxCallsComplete();
        ...
        ///<summary>
        /// Test to check if Early Years Pupils grid exists
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void ShowEarlyYearsPupilCheckForSummer2017()
        {
            NavigateToReturnPage();
            Wait.WaitTillAllAjaxCallsComplete();
        ...
        ///<summary>
        /// Test to check if school lunch taken grid exists
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void SchoolLunchTakenCheckForSummer2017()
        {
            NavigateToReturnPage();
            Wait.WaitTillAllAjaxCallsComplete();
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void CheckOnlyOneReturnExistsForSummer2017()
        {
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.ReturnsManager);
            AutomationSugar.NavigateMenu(DataExchangeElement.MenuTopLevel, DataExchangeElement.MenuCategory, DataExchangeElement.MenuItem);
            var censusTripletPage = new CensusPage();
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void CheckTabExistsForSummer2017()
        {
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void CheckReportsExistsForSummer2017()
        {
            bool tabExists;
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void CheckSchoolCensusSectionExistsForSummer2017()
        {
            bool isExists = false;
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P2 })]
        public void CheckSaveProcessForSummer2017()
        {
            bool isExists = false;
        ...
        /// </summary>
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P1 })]
        public void CheckValidateProcessForSummer2017()
        {
            bool isExists = false;
        ...
        [Variant(Variant.EnglishStatePrimary)]
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { ReturnVersion.Summer2017, BugPriority.P1 })]
        public void CheckSignOffProcessForSummer2017()
        {
            bool isExists = false;
