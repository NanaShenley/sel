...
{
    public class AddBuildingAddressPopupPage : BaseSeleniumComponents
    {
#pragma warning disable 0649
       [FindsBy(How = How.Id, Using = "dialog-dialog-dialog-editableData")]
       ...
       public AddBuildingAddressPopupPage()
        {
       ...
       public AddSchoolBuildingPopupPage OkButtonAddress()
       {
           okButton.Click();
