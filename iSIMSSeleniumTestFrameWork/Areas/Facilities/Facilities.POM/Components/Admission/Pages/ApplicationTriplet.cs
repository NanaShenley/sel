...
namespace POM.Components.Admission
{
    public class ApplicationTriplet : BaseComponent
    {
        ...
        public ApplicationSearchPage SearchCriteria { get { return _searchCriteria; } }
        ...
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='add_new_application_button']")]
        private IWebElement _addNewApplicationButton;
    ...
    public class ApplicationSearchPage : SearchCriteriaComponent<ApplicationTriplet.ApplcationsSearchResultTile>
    {
        ...
        [FindsBy(How = How.Name, Using = "ApplicantName")]
        private IWebElement _searchByName;

        [FindsBy(How = How.Name, Using = "AdmissionGroup.dropdownImitator")]
        private IWebElement _searchByAdmissionGroup;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(1) input")]
        private IWebElement _appliedCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(2) input")]
        private IWebElement _offeredCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(3) input")]
        private IWebElement _acceptedCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(4) input")]
        private IWebElement _admittedCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(5) input")]
        private IWebElement _rejectedCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(6) input")]
        private IWebElement _reservedCheckbox;

        [FindsBy(How = How.CssSelector, Using = "div[class = 'checkboxlist'] :nth-child(7) input")]
        private IWebElement _witdDrawnCheckbox;
        ...
        public void SetStatus(string statusName, bool isCheck)
        {
            ...
            IList<IWebElement> listCheckboxLabel = SeleniumHelper.FindElements(SimsBy.CssSelector("[data-automation-id = 'search_criteria'] .checkboxlist-column label"));
            IList<IWebElement> listCheckboxInput = SeleniumHelper.FindElements(SimsBy.CssSelector("[data-automation-id = 'search_criteria'] .checkboxlist-column input"));
