...
{
    public class AllocateFuturePupilsTriplet : BaseComponent
    {
        ...
        public AllocateFuturePupilsTriplet()
        {
            _searchCriteria = new AllocateFuturePupilsSearchPage(this);
        }

        #region Search

        private readonly AllocateFuturePupilsSearchPage _searchCriteria;

        public AllocateFuturePupilsSearchPage SearchCriteria
        {
    ...
    public class AllocateFuturePupilsSearchPage : SearchTableCriteriaComponent
    {
        public AllocateFuturePupilsSearchPage(BaseComponent component) : base(component) { }
