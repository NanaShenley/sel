...
namespace Pupil.Data
{
    ...
    {
        public static DataPackage AddBasicLearner(this DataPackage dataPackage, Guid learnerId, string surname,
            string forename, DateTime dateOfBirth, DateTime dateOfAdmission, string genderCode = "1",
            string enrolStatus = "C", Guid? uniqueLearnerEnrolmentId = null, int? tenantId = null,
            string salutation = null, string addressee = null, Guid? yearGroupId = null, Guid? schoolNCYearId = null,
            bool addAddress = false)
        {
            ...
            if (addAddress)
            {
                ...
                dataPackage.AddData("Address", new
                {
                    Id = addressId,
                    UPRN = "ABCDE",
                    PostCode = "AB1 2CD",
                ...
                dataPackage.AddData("LearnerAddress", new
                {
                    Id = Guid.NewGuid(),
                    Learner = learnerId,
                    Address = addressId,
                    AddressType = CoreQueries.GetLookupItem("AddressType", tenantId.Value, description: "Home"),
