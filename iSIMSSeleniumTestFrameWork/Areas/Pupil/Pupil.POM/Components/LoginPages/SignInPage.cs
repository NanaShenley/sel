...
namespace POM.Components.LoginPages
{
...
#pragma warning disable 0649
        ...
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='email-account-login']")]
        private IWebElement _email;

        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='password-account-login']")]
...
#pragma warning restore 0649
        ...
        public SignInPage()
        {
            Wait.WaitForElement(By.CssSelector("[data-automation-id='email-account-login']"));
