...
{
    public class AddAddressPopup : BaseDialogComponent
    {
        ...
        {
            AutomationSugar.WaitFor(new ByChained(this.ComponentIdentifier, SeSugar.Automation.SimsBy.AutomationId("input_jobstep_button")));
            AutomationSugar.ClickOn(new ByChained(this.ComponentIdentifier, SeSugar.Automation.SimsBy.AutomationId("input_jobstep_button")));
            AutomationSugar.WaitForAjaxCompletion();
        }

        public void ClickClear()
        {
            AutomationSugar.WaitFor(new ByChained(this.ComponentIdentifier, SeSugar.Automation.SimsBy.AutomationId("clear_jobstep_button")));
            AutomationSugar.ClickOn(new ByChained(this.ComponentIdentifier, SeSugar.Automation.SimsBy.AutomationId("clear_jobstep_button")));
            AutomationSugar.WaitForAjaxCompletion();
        }
