...
namespace POM.Components.Pupil
{
    ...
    {
        public override By DialogIdentifier => SimsBy.AutomationId("sen_review_record_detail");
        ...
        [FindsBy(How = How.CssSelector, Using = "[data-automation-id='add_sen_review_contributor_button']")]
