...
namespace POM.Components.Pupil
{
    public class DoctorsDialog : BaseDialogComponent
    {
        ...
        {
            get { return SimsBy.AutomationId("doctor_dialog"); }
        }
        ...
        public GridComponent<DoctorAddressRow> DoctorAddressTable
        {
            ...
            get
            {
                ...
                Retry.Do(() =>
                {
                    returnValue = new GridComponent<DoctorAddressRow>(By.CssSelector("#dialog-dialog-editableData [data-maintenance-container='Addresses']"), ComponentIdentifier);
                });
                return returnValue;
            }
        }
