...
{
    public class PupilPremiumRecordSearchPage : SearchCriteriaComponent<PupilPremiumRecordTriplet.PupilPremiumRecordSearchResultTile>
    {
        public PupilPremiumRecordSearchPage(BaseComponent parent) : base(parent) { }
        ...
        [FindsBy(How = How.Name, Using = "HasPupilPremiumCriterion")]
        private IWebElement _hasPupilPremiumCheckBox;
        ...
        public bool HasPupilPremium
        {
            set { _hasPupilPremiumCheckBox.Set(value); }
            get { return _hasPupilPremiumCheckBox.IsChecked(); }
        }
