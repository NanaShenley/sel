...
{
    public class PupilRecordSearchPage : SearchCriteriaComponent<PupilRecordTriplet.PupilRecordSearchResultTile>
    {
        public PupilRecordSearchPage(BaseComponent parent) : base(parent) { }
