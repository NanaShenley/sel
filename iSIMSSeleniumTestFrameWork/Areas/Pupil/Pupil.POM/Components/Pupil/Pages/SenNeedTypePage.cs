...
{
    public class SenNeedTypePage : BaseComponent
    {
        ...
        public GridComponent<SENNeed> SenNeedTypeTable
        {
            get
            {
                ...
                Retry.Do(() =>
                {
                    returnValue = new GridComponent<SENNeed>(By.CssSelector("[data-maintenance-grid-id='LookupsWithCategoryGrid1']"), ComponentIdentifier);
                });
                return returnValue;
            }
        }
