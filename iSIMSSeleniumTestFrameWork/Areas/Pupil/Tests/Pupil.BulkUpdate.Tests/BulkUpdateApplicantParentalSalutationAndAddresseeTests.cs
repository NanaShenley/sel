...
using Wait = POM.Helper.Wait;

namespace Pupil.BulkUpdate.Tests
{
	public class BulkUpdateApplicantParentalSalutationAndAddresseeTests
	{
		//private POM.Helper.SeleniumHelper.iSIMSUserType LoginAs = POM.Helper.SeleniumHelper.iSIMSUserType.SchoolAdministrator;
		private SeleniumHelper.iSIMSUserType LoginAs = SeleniumHelper.iSIMSUserType.TestUser;
		...
		[WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.ApplicantBulkUpdateSalutationGenerate, PupilTestGroups.Priority.Priority2, "BU_CFAPS" })]
        ...
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.ApplicantBulkUpdateSalutationGenerate, PupilTestGroups.Priority.Priority2, "BU_CFAPSWONC" })]
        ...
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.ApplicantBulkUpdateAddresseeGenerate, PupilTestGroups.Priority.Priority2, })]
        ...
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.ApplicantBulkUpdateAddresseeGenerate, PupilTestGroups.Priority.Priority2, "BU_CUIAPA" })]
        ...
        [WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.ApplicantBulkUpdateAddresseeGenerate, "BU_CSBAPSS" })]
