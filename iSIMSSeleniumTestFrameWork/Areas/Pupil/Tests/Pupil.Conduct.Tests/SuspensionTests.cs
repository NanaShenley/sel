...
namespace Pupil.Conduct.Tests
{
    public class SuspensionTests
    {
        ...
        readonly string _pattern = "d/M/yyyy";

        /// <summary>
        /// Description: Create a New Suspension
        /// </summary>
        //[WebDriverTest(TimeoutSeconds = 2000, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.Suspensions.Page, PupilTestGroups.Priority.Priority2, "FAIL" })]
        public void Suspensions_AddSuspension()
        {
            ...
            using (new DataSetup(purgeBeforeInsert: false, purgeAfterTest: true, packages: dataPackage))
            {
                try
                {
                    ...
                    addSuspensionDialog.StartDate = new DateTime(DateTime.Today.Year, 2, 2).ToString(_pattern);
                    addSuspensionDialog.EndDate = new DateTime(DateTime.Today.Year, 3, 3).ToString(_pattern);
                    addSuspensionDialog.StartTime = "09:00";
                    addSuspensionDialog.EndTime = "16:00";
                    addSuspensionDialog.Length = "25";
                    addSuspensionDialog.Note = Utilities.GenerateRandomString(10, "AddSuspension");
                    addSuspensionDialog.SessionsMissed = "5";
        ...
        /// </summary>
        //[WebDriverTest(TimeoutSeconds = 2000, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[]
        //{
        //    PupilTestGroups.Suspensions.Page, PupilTestGroups.Priority.Priority2,"FAIL"
        //})]
        public void Suspension_UpdateSuspension()
        {
            ...
            using (new DataSetup(purgeBeforeInsert: false, purgeAfterTest: true, packages: dataPackage))
            {
                try
                {
                    ...
                    var exclusionStartDate = DateTime.ParseExact("02/02/2016", _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
                    var exclusionMeetingStartDate =
                        DateTime.ParseExact("02/04/2016", _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
        ...
        /// </summary>
        //[WebDriverTest(TimeoutSeconds = 2000, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.Suspensions.Page, PupilTestGroups.Priority.Priority2, "TESTME" })]
        ...
        public void Suspensions_Overlap()
        {
            ...
            using (new DataSetup(purgeBeforeInsert: false, purgeAfterTest: true, packages: dataPackage))
            {
                try
                {
                    ...
                    var exclusionStartDate = DateTime.ParseExact("02/02/2016", _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
                    var exclusionEndDate = DateTime.ParseExact("02/04/2016", _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
                    ...
                    addNewSuspensionDialog.Length = exclusionLength;
                    addNewSuspensionDialog.SessionsMissed = exclusionLength;
        ...
        public void Suspensions_DeletePupil()
        {
            ...
            using (new DataSetup(purgeBeforeInsert: false, purgeAfterTest: true, packages: dataPackage))
            {
                ...
                // Verify message displays.
                IWebElement _successMessage = SeleniumHelper.FindElement(SeSugar.Automation.SimsBy.AutomationId("status_success"));
