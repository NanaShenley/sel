...
namespace Pupil.Pupil.Tests
{
    public class DisabledTests2
    {
        ...
        public void TC_PU020_Exercise_ability_to_change_a_Pupils_address(string foreName, string surName, string gender, string DOB, string dateOfAdmission, string yearGroup, string className, string[] address, string[] newAddress)
        {
            ...
            SeleniumHelper.NavigateQuickLink("Pupil Records");
            pupilRecords = new PupilSearchTriplet();
                    ...
                    string title, string contactSurname, string contactForeName, string[] address, string[] newAddress)
        {
            ...
            addContact.ClickAddAddress();

            var addAddress = new AddContactAddressDialog();
            addAddress.BuildingNo = address[0];
            addAddress.BuildingName = address[1];
            addAddress.Flat = address[2];
            addAddress.Street = address[3];
        ...
        /// Description: PU-031a : 
        /// </summary>
        //[WebDriverTest(TimeoutSeconds = 1200, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.PupilRecord.ContactTests, PupilTestGroups.Priority.Priority3 }, DataProvider = "TC_PU031a_Data")]
        ...
        /// Description: PU-031b : 
        /// </summary>
        //[WebDriverTest(TimeoutSeconds = 1200, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.PupilRecord.ContactTests, PupilTestGroups.Priority.Priority3 }, DataProvider = "TC_PU031b_Data")]
        ...
        //[WebDriverTest(TimeoutSeconds = 2000, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.PupilRecord.Leaver, PupilTestGroups.Priority.Priority4 }, DataProvider = "TC_PU025_Data")]
        ...
        /// </summary>
        //TODO: Duplicate to TC_PU026
        //[WebDriverTest(TimeoutSeconds = 1800, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.PupilRecord.Leaver, PupilTestGroups.Priority.Priority4 }, DataProvider = "TC_PU043_DATA")]
        ...
        public void UndoMakeLeaver()
        {
            ...
            var pupilSearch = new PupilSearchTriplet();
            ...
            //Search for current non-leaver
            pupilSearch = new PupilSearchTriplet();
       ...
       //     Groups = new[] { PupilTestGroups.PupilRecord.AddNewPupil, PupilTestGroups.PupilRecord.Page, PupilTestGroups.Priority.Priority3 })]
        public void TC_PU019_Exercise_ability_to_search_for_existing_pupil()
        {
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.TestUser);
            ...
            string dobInput = DateTime.ParseExact(dob.ToString(_pattern), _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
            string dateOfAdmission = DateTime.ParseExact(doa.ToString(_pattern), _pattern, CultureInfo.InvariantCulture).ToString(_pattern);
            var yearGroup = Queries.GetFirstYearGroup();
            var className = Queries.GetFirstPrimaryClass();
            string gender = "Male";
            ...
            addNewPupilDialog.SurName = surname;
            addNewPupilDialog.Gender = gender;
            addNewPupilDialog.DateOfBirth = dobInput;
            var registrationDetailDialog = addNewPupilDialog.Continue();
            registrationDetailDialog.DateOfAdmission = dateOfAdmission;
            registrationDetailDialog.YearGroup = yearGroup.FullName;
            registrationDetailDialog.ClassName = className.FullName;
            registrationDetailDialog.CreateRecord();
            //var confirmRequiredDialog = new POM.Components.Common.ConfirmRequiredDialog();
            //confirmRequiredDialog.ClickOk();
            ...
            pupilRecords.SearchCriteria.Class = className.FullName;
            pupilSearchResults = pupilRecords.SearchCriteria.Search();
            pupilTile = pupilSearchResults.FirstOrDefault(t => t.Name.Equals(String.Format("{0}, {1}", surname, forename)));
            ...
            pupilRecords.SearchCriteria.IsCurrent = true;
            pupilRecords.SearchCriteria.ClickSearchAdvanced(true);
            pupilRecords.SearchCriteria.YearGroup = yearGroup.FullName;
            pupilSearchResults = pupilRecords.SearchCriteria.Search();
            pupilTile = pupilSearchResults.FirstOrDefault(t => t.Name.Equals(String.Format("{0}, {1}", surname, forename)));
