...
namespace Pupil.Smoke.Tests
{
    public class PupilScreenSmokeTests
    {
        ...
        //Santosh - Move this to Admissions area
        //[WebDriverTest(Enabled = true, Browsers = new[] { BrowserDefaults.Chrome }, Groups = new[] { PupilTestGroups.ApplicantBulkUpdate.Page, PupilTestGroups.Priority.Priority1 })]
