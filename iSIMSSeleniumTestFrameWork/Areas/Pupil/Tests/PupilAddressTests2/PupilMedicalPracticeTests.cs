...
namespace Pupil.Pupil.Tests
{
	public class PupilMedicalPracticeTests
	{
		...
		[WebDriverTest(TimeoutSeconds = 1200, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome },
			Groups = new[]
			{
				PupilTestGroups.PupilRecord.Address, PupilTestGroups.PupilRecord.Page, PupilTestGroups.Priority.Priority2,
				"DoctorAddress", "Edit_Medical_Practice_Add_Doctor_Address_Local"
			})]
		...
		[WebDriverTest(TimeoutSeconds = 1200, Enabled = true, Browsers = new[] { BrowserDefaults.Chrome },
			Groups = new[]
			{
				PupilTestGroups.PupilRecord.Address, PupilTestGroups.PupilRecord.Page, PupilTestGroups.Priority.Priority2,                "DoctorAddress",
