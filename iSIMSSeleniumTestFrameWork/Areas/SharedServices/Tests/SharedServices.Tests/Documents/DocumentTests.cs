...
namespace SharedServices.Tests.Documents
{
    ...
    public class DocumentTests
    {
        ...
        [WebDriverTest(Groups = new[] { TestGroups.NewDocStoreForTopLevelEntity, TestGroups.P2 }, Browsers = new[] { BrowserDefaults.Ie, BrowserDefaults.Chrome }, TimeoutSeconds = 5000)]
        ...
        [WebDriverTest(Groups = new[] { TestGroups.NewDocStoreForTopLevelEntity, TestGroups.P2, "paul" }, Browsers = new[] { BrowserDefaults.Ie, BrowserDefaults.Chrome }, TimeoutSeconds = 5000)]
        public void Delete_Document_ToTopLevelEntity()
        {
            ...
            var personData = new PersonData("Note2");
        ...
        [WebDriverTest(Groups = new[] { TestGroups.NewDocStore, TestGroups.P2 }, Browsers = new[] { BrowserDefaults.Ie, BrowserDefaults.Chrome }, TimeoutSeconds = 5000)]
        public void Add_Documents()
        {
            ...
            var fileName = Settings.Default.FilePath;
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.SchoolAdministrator, enabledFeatures: "SharedServiceMockUI");
            var personData = new PersonData("Note3");
        ...
        [WebDriverTest(Groups = new[] { TestGroups.NewDocStore, TestGroups.P2, "paul" }, Browsers = new[] { BrowserDefaults.Ie, BrowserDefaults.Chrome }, TimeoutSeconds = 5000)]
        public void Delete_Document()
        {
            ...
            var personData = new PersonData("Note4");
        ...
        public void Add_Note()
        {
            // Arrange
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.SchoolAdministrator, enabledFeatures: "SharedServiceMockUI");
            var personData = new PersonData("Note5");
            bool actual;
        ...
        public void Delete_Note()
        {
            ...
            var fileName = Settings.Default.FilePath;
            SeleniumHelper.Login(SeleniumHelper.iSIMSUserType.SchoolAdministrator, enabledFeatures: "SharedServiceMockUI");
            var personData = new PersonData("Note6");
            bool actual;
        ...
        private class PersonData
        {
            ...
            {
                _id = Guid.NewGuid();
                _forename = Utilities.GenerateRandomString(15, "Selenium");
                Surname = Utilities.GenerateRandomString(15, "Selenium");
