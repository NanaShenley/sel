...
namespace SharedServices.Tests.ManageUsers
{
    ...
    {
        private Components.UserNotification.ManageUsers _manageUsers;

        [NotDone]
        [WebDriverTest(Groups = new[] { TestGroups.ManageUsers, TestGroups.P2 }, Browsers = new[] { BrowserDefaults.Chrome })]
        ...
        private string CreateUser()
        {
            ...
            _manageUsers = new Components.UserNotification.ManageUsers();
