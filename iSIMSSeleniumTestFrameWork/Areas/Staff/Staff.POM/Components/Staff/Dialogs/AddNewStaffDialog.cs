...
{
    public class AddNewStaffDialog : BaseDialogComponent
    {
        ...
        public string DateOfBirth
        {
            ...
            set { _dateOfBirthTextBox.SetText(value); }
        ...
        public ServiceDetailDialog Continue()
        {
            SeSugar.Automation.Retry.Do(_continueButton.ClickByJS);
            Wait.WaitForAjaxReady(By.CssSelector(".locking-mask"));
            return new ServiceDetailDialog();
        }

        public StaffRecordPage ClickCancel()
        {
            AutomationSugar.ClickOnAndWaitForUntilStale(new ByChained(SimsBy.AutomationId("cancel_button"), this.ComponentIdentifier), this.ComponentIdentifier);
