...
{
    public class DisabilityIndicatorDetailsPage : BaseComponent
    {
        ...
        public GridComponent<DisabilityIndicatorRow> DisabilityIndicatorRows
        {
            get
            {
                return new GridComponent<DisabilityIndicatorRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithProviderGrid1']"), ComponentIdentifier);
            }
        }

        public class DisabilityIndicatorRow : GridRow
        {
