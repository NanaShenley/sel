...
{
    public class EmploymentContractDestinationDetailsPage : BaseComponent
    {
        ...
        public GridComponent<EmploymentContractDestinationRow> LookupGrid
        {
            get
            {
                return new GridComponent<EmploymentContractDestinationRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithCategoryGrid1']"), ComponentIdentifier);
            }
        }

        public class EmploymentContractDestinationRow : GridRow
        {
