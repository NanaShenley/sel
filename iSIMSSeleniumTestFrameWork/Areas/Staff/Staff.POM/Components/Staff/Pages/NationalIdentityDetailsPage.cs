...
{
    public class NationalIdentityDetailsPage : BaseComponent
    {
        ...
        public GridComponent<NationalIdentitiesRow> NationalIdentities
        {
            get
            {
                return new GridComponent<NationalIdentitiesRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithProviderGrid1']"), ComponentIdentifier);
            }
        }

        public class NationalIdentitiesRow : GridRow
        {
