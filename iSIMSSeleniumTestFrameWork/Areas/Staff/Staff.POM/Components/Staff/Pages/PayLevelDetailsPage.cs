...
{
    public class PayLevelDetailsPage : BaseComponent
    {
        ...
        public GridComponent<PayLevelRow> LookupGrid
        {
            get
            {
                return new GridComponent<PayLevelRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithProviderGrid1']"), ComponentIdentifier);
            }
        }

        public class PayLevelRow : GridRow
        {
