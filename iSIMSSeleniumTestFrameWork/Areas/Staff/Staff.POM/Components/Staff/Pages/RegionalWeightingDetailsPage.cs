...
{
    public class RegionalWeightingDetailsPage : BaseComponent
    {
        ...
        public GridComponent<RegionalWeightingRow> RegionalWeightings
        {
            get
            {
                return new GridComponent<RegionalWeightingRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithProviderGrid1']"), ComponentIdentifier);
            }
        }

        public class RegionalWeightingRow : GridRow
        {
