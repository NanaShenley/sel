...
{
    public class StaffReligionCategoryDetailsPage : BaseComponent
    {
        ...
        public GridComponent<StaffReligionCategoriesRow> StaffReligionCategories
        {
            get
            {
                return new GridComponent<StaffReligionCategoriesRow>(By.CssSelector("[data-maintenance-grid-id='LookupsWithCategoryGrid1']"), ComponentIdentifier);
            }
        }

        public class StaffReligionCategoriesRow : GridRow
        {
