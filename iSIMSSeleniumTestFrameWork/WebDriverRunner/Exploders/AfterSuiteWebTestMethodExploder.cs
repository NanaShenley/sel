...
{
    public class AfterSuiteWebTestMethodExploder : MethodExploderBase
    {
        private readonly IMultiplier _afterSuiteWebTestMethodMultiplier;
        ...
        public IReadOnlyCollection<TestMethodInstance> ExplodeAfterSuiteWebTest()
        {
            return Explode(_afterSuiteWebTestMethodMultiplier);
        }
