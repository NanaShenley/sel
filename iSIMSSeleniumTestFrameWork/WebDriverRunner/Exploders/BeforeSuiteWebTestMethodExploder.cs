...
{
    public class BeforeSuiteWebTestMethodExploder : MethodExploderBase
    {
        private readonly IMultiplier _beforeSuiteWebTestMethodMultiplier;
        ...
        {
            return Explode(_beforeSuiteWebTestMethodMultiplier);
        }
    }
}
