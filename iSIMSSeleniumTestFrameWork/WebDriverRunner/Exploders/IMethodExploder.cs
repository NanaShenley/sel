...
{
    interface IMethodExploder
    {
        TestMethodInstance GetSkippedInstance(RunnerException runnerException);
        IReadOnlyCollection<TestMethodInstance> Explode(IMultiplier testMethodMultiplier);
