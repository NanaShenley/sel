...
{
    public class AfterSuiteWebTestListner : TestlistenerBase
    {
        public AfterSuiteWebTestListner(Configuration config)
            : base(config)
        {
        }
        ...
        {
            if (instance.Attr.GetType() == typeof(AfterSuiteWebTestAttribute))
            {
