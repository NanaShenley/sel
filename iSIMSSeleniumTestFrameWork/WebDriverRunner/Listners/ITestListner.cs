...
{
    interface ITestListner
    {
        void OnTestStart(TestMethodInstance instance, ITestResult result);

        void OnTestFinished(TestMethodInstance instance, ITestResult result);

        void OnTestPassed(TestMethodInstance instance, ITestResult result);

        void OnTestFailed(TestMethodInstance instance, ITestResult result);

        void OnTestSkipped(TestMethodInstance instance, ITestResult result);
        
        void SetUpAndStartBrowsers(TestMethodInstance instance, ITestResult result);
        
        void CloseBrowser(IWebDriver webDriver);
