...
{
    internal class AfterSuiteWebTestFinder : TestFinderBase
    {
         
        public AfterSuiteWebTestFinder(Assembly assembly, IFilter<MethodInfo> methodFilter)
        {
            Assembly = assembly;
            MethodFilter = methodFilter ?? new AfterSuiteWebTestMethodFilter();
        }
