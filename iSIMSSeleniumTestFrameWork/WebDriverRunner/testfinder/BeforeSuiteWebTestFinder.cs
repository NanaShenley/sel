...
{
    internal class BeforeSuiteWebTestFinder :TestFinderBase
    {
         
        public BeforeSuiteWebTestFinder(Assembly assembly, IFilter<MethodInfo> methodFilter)
        {
            Assembly = assembly;
            MethodFilter = methodFilter ?? new BeforeSuiteWebTestMethodFilter();
        }
