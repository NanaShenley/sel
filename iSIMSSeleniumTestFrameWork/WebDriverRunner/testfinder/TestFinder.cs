...
{
    public class TestFinder : TestFinderBase
    {
        public TestFinder(Assembly assembly, IFilter<MethodInfo> methodFilter)
        {
            Assembly = assembly;
            MethodFilter = methodFilter ?? new DefaultTestMethodFilter(true, Selene.Support.Attributes.Variant.All, Guid.Empty);
        }        
    }
}
