...
namespace WebDriverRunner.webdriver
{
    ...
    {
        private static readonly ThreadLocal<ITestResult> ThreadLocal = new ThreadLocal<ITestResult>();
        ...
        {
            ThreadLocal.Value.Log(new Log(msg));
        }
        public static void Log(Log l)
        {
            ThreadLocal.Value.Log(l);
        }
    }
}
